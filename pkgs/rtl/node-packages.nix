...
in
{
  "rtl-git+https://github.com/Ride-The-Lightning/RTL#v0.11.0" = nodeEnv.buildNodePackage {
    name = "rtl";
    packageName = "rtl";
    version = "0.11.0-beta";
    src = fetchgit {
      ...
      sha256 = "d9a39857b53e6bb857db2fa996615b29487c39f77933ba50559db10251a1f1f4";
    };
    dependencies = [
